  ...
  <div class="card">
    <h3>Map</h3>
      <div class="card-body">
        ...
        <kendo-map-layer          :type="'tile'"          :url-template="'https://#= subdomain #.tile.openstreetmap.org/#= zoom #/#= x #/#= y #.png'"
          :subdomains="['a', 'b', 'c']"          :attribution="'&copy; <a href=\'https://osm.org/copyright\'> OpenStreetMap contributors</a>'">        </kendo-map-layer>
        <kendo-map-marker           :location="[1.3042291286530805, 103.8319619254719]">        </kendo-map-marker>
